...
2.  답변의 근거가 되는 가장 중요한 법 조항 1~2개를 출처로 명시하고, **해당 법 조항으로 바로 갈 수 있는 링크를 다음 형식에 맞춰 생성**해 주세요. 링크 형식: \`https://www.law.go.kr/LSW/lsInfoP.do?lsiSeq=XXXXX#JO_조항번호\` (XXXXX는 법령 고유번호이며, 참고 자료에서 찾아야 합니다.)
